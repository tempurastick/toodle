...
![Add task screenshot](./documentation_assets/add_task.png)

- Add a task to the list and choose between three priority status.

![Delete a task screenshot](./documentation_assets/delete_task.png)

- Delete previously created tasks as needed.

![task overview screenshot](./documentation_assets/task_overview.png)

- View all currently existing tasks. They will have chips showing their priority and completion status.

![edit task screenshot](./documentation_assets/edit_task.png)
